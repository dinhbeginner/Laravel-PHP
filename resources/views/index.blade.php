                                        ...
                                        @endif
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <input required="" class="form-control @error('old_password') is-invalid @enderror" id="current_password" placeholder="Old Password" name="old_password" type="password" >
                                                    @error('old_password')
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    @error('new_password') is-invalid @enderror"  id="new_password_confirmation" placeholder="Confirm New Password"/>
