                    ...
                    <div class="col-xl-6 col-lg-8 col-md-12 m-auto">
                        <div class="row">
                            <div class="heading_s1">
                                ...
                                <h2 class="mb-15 mt-15">Your email</h2>
                                    ...
                                    <div class="padding_eight_all bg-white">
                                        <form method="POST" action="{{ route('password.email') }}">
                                            ...
                                            <div class="form-group">
                                                <input type="text" required="" id="email" name="email" placeholder="Email reset password *" />
                                            </div>
                                            {{-- <div class="form-group">
                                                <input type="text" required="" id=""name="email" placeholder="Confirm you password *" />
                                            </div> --}}
                                            <div class="form-group">
