				...
				<div class="form-group col-md-6">
				  ...
				  <div class="form-group col-12">
					...
					<select name="brand_id" class="form-select" id="inputProductType">
                        ...
                        <option value="{{ $brand->id }}" {{ $brand->id == $products->brand_id ? 'selected' : '' }} >{{ $brand->brand_name }}</option>						 @endforeach
					  </select>
				  </div>
				  ...
				  <div class="form-group col-12">
					...
					<select name="category_id" class="form-select" id="inputVendor">
                        ...
                        <option value="{{ $cat->id }}" {{ $cat->id == $products->category_id ? 'selected' : '' }}>{{ $cat->category_name }}</option>						 @endforeach
					  </select>
				  </div>
				  ...
				  <div class="form-group col-12">
					...
					<select name="subcategory_id" class="form-select" id="inputCollection">
                        ...
                        <option value="{{ $subcat->id }}" {{ $subcat->id == $products->subcategory_id ? 'selected' : '' }}>{{ $subcat->subcategory_name }}</option>						 @endforeach
				  ...
				  <div class="col-12">
                    ...
                    <option value="{{ $vendor->id }}" {{ $vendor->id == $products->vendor_id ? 'selected' : '' }}>{{ $vendor->name }}</option>						 @endforeach
					  </select>
				  </div>
...
<!-- /// Main Image Thambnail Update ////// -->
            ...
            <div class="page-content">
                <div class="mb-0 text-uppercase" >Update Main Image Thmbnail</div>
                <hr>
                <div class="card">
                    <form action="{{ route('update.product.thambnail') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="file" id="formFile"name="product_thambnail" class="form-control">
                            </div>
                            <div class="mb-3">
                                <label for="formFile" class="form-label">Chose Thambnail image</label>
...
<div class="card-body">
	<table class="table mb-0 table-striped">
		...
		<tbody>
            ...
            <form method="post" action="{{ route('update.product.multiimage') }}" enctype="multipart/form-data" >			@csrf
