                               ...
                               <input type="hidden" name="old_image" value="{{$brand->brand_image}}">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-sm-9 text-secondary">
                                        <input type="text" name="brand_name" id="name" class="form-control" value="{{ $brand->brand_name }}" />
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                    <img src="{{ asset($brand->brand_image) }}" id="showImage"  style="width: 100px;height: 100px;">
                                    </div>
                                </div>
                                <div class="row">
